...
static struct ys_auxiliary_driver ys_adrvs[] = {
	YS_AUX_DRV(AUX_NAME_ETH, ys_aux_eth_probe, ys_aux_eth_remove,
		   ys_eth_id_table, AUX_TYPE_ETH),
	YS_AUX_DRV(AUX_NAME_SF, ys_aux_sf_probe, ys_aux_sf_remove,
		   ys_sf_id_table, AUX_TYPE_SF),
	YS_AUX_DRV(AUX_NAME_REP, ys_aux_rep_probe, ys_aux_rep_remove,
		   ys_rep_id_table, AUX_TYPE_REP),
	YS_AUX_DRV(AUX_NAME_I2C, ys_aux_i2c_probe, ys_aux_i2c_remove,
		   ys_i2c_id_table, AUX_TYPE_I2C),
	YS_AUX_DRV(AUX_NAME_PTP, ys_aux_ptp_probe, ys_aux_ptp_remove,
		   ys_ptp_id_table, AUX_TYPE_PTP),
	YS_AUX_DRV(AUX_NAME_LAN, ys_aux_lan_probe, ys_aux_lan_remove,
		   ys_lan_id_table, AUX_TYPE_LAN),
	YS_AUX_DRV(AUX_NAME_MAC, ys_aux_mac_probe, ys_aux_mac_remove,
		   ys_mac_id_table, AUX_TYPE_MAC),
	YS_AUX_DRV(AUX_NAME_MBOX, ys_aux_mbox_probe, ys_aux_mbox_remove,
		   ys_mbox_id_table, AUX_TYPE_MBOX),
	YS_AUX_DRV(AUX_NAME_NP, ys_aux_np_probe, ys_aux_np_remove,
		   ys_np_id_table, AUX_TYPE_NP),
	YS_AUX_DRV(AUX_NAME_DOE, ys_aux_doe_probe, ys_aux_doe_remove,
		   ys_doe_id_table, AUX_TYPE_DOE),
	YS_AUX_DRV(AUX_NAME_VDPA, ys_aux_vdpa_probe, ys_aux_vdpa_remove,
		   ys_vdpa_id_table, AUX_TYPE_VDPA),
